...
| delusionTasks_allLanguages | 392 | ✅ проза кол.20 (я 1-145 + пейн 146-391): Подземелья, Скальпель/Сакраментальный/Искажённый/Аэнгуин/эфирист/«Скригриб», род Колыбели; ФЛАГИ ЦЕЛЫ (diff=только легенда, 0 кириллицы, NF=EN) |
| delusionItemData_Master / AlchemyCombo / PlayerHouse | 266/35/28 | ✅ пейн: 100% структурные (ID/числа), переводимой прозы нет — правок не требуется |
